    ...
    <div className={`flex h-screen overflow-hidden ${darkMode ? "dark" : ""}`}>
      ...
      <div className="md:hidden fixed top-1 left-4 z-50">
        <button
          ...
          className={`p-2 rounded-md shadow-sm transition-colors ${darkMode
      ...
      <div
        ...
        ${sidebarOpen ? "translate-x-0" : "-translate-x-full"
          } md:translate-x-0 ${darkMode ? "bg-gray-900 text-gray-100" : "bg-white text-gray-800"
          }`}
      >
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Navbar */}
        <header
          className={`sticky top-0 z-10 w-full h-20 flex items-center justify-between px-10 ${darkMode
            ...
            <div className="flex-1 mx-6 max-w-md">
              ...
              >
                <input
                  ...
                  className={`w-full px-4 py-2 rounded-full text-sm outline-none focus:ring-2 focus:ring-blue-400 ${darkMode
            ...
            <div className="relative">
              ...
              >
                <div className="text-sm">
                  <p
                    className={`font-semibold capitalize ${darkMode ? "text-white" : "text-gray-800"
                      }`}
                  >
                    {name}
                  </p>
              ...
              {dropdownOpen && (
                <div
                  className={`absolute right-0 top-12 w-56 rounded-md shadow-lg ring-1 z-20 origin-top-right ${darkMode
                ...
                >
                  ...
                  <div
                    className={`py-1 border-t ${darkMode ? "border-gray-700" : "border-gray-200"
                      }`}
                  >
                    <button
        ...
        <main
          className={`flex-1 overflow-y-auto p-4 transition-colors duration-300 ${darkMode ? "bg-gray-900 text-gray-100" : "bg-gray-50 text-gray-800"
            }`}
        >
